...
# Home assignment 3: Сравнительный анализ EKF для оценки ориентации (Attitude Estimation)
...
2. Анализ и Визуализация:
    • В ipynb-файле должны присутствовать следующие графики:
        ➢ Графики углов: Постройте Roll, Pitch, Yaw для обоих методов на одном графике (для варианта Б переведите кватернионы в углы Эйлера
для наглядности сравнения).
        ➢ Анализ нормы: Для варианта Б постройте график нормы кватерниона перед этапом нормализации. Это покажет, как накапливается
